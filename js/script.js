/**
 * BHAIRAV BABA TEMPLE - MAIN JAVASCRIPT
...
function createGalleryItem(imagePath) {
    ...
    img.src = imagePath;
    img.alt = `Bhairav Baba Temple - ${imagePath}`;
    img.loading = 'lazy';

    item.appendChild(img);
    
    // Add click handler for lightbox effect (optional)
 ...
 */
console.log('%c🙏 Bhairav Baba Temple Website Loaded Successfully! 🙏', 
    'color: #FFD700; font-size: 16px; font-weight: bold; text-shadow: 0 0 10px rgba(255, 215, 0, 0.5);');
console.log('%cDeveloped with love and spiritual devotion', 
    'color: #FF4500; font-style: italic;');
